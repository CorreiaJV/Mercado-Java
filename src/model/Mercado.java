...
public class Mercado {
	...
	private static void menu() {
		...
		int opcao = 0;
		try {
			opcao = Integer.parseInt(Mercado.ler.nextLine());
	...
	private static void cadastrarProduto() {
		...
		String nome = Mercado.ler.nextLine();

		System.out.println("Informe o preço do produto");
		Double preco = Mercado.ler.nextDouble();
	...
	private static void comprarProduto() {
		if(Mercado.produtos.size() > 0) {
			...
			int codigo = Integer.parseInt(Mercado.ler.nextLine());
			boolean tem = false;
			...
			for(Produto p : Mercado.produtos) {
				...
				if(tem) {
					...
					int op = Integer.parseInt(Mercado.ler.nextLine());
